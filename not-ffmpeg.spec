...
Source0  : https://ffmpeg.org/releases/ffmpeg-7.0.1.tar.gz
Source1  : https://ffmpeg.org/releases/ffmpeg-7.0.1.tar.gz.asc
...
%setup -q -n ffmpeg-7.0.1
cd %{_builddir}/ffmpeg-7.0.1
%patch -P 1 -p1
pushd ..
cp -a ffmpeg-7.0.1 buildavx2
popd
pushd ..
cp -a ffmpeg-7.0.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720062961
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libavcodec.so.61.3.100
/V3/usr/lib64/libavdevice.so.61.1.100
/V3/usr/lib64/libavfilter.so.10.1.100
/V3/usr/lib64/libavformat.so.61.1.100
/V3/usr/lib64/libavutil.so.59.8.100
/V3/usr/lib64/libpostproc.so.58.1.100
/V3/usr/lib64/libswresample.so.5.1.100
/V3/usr/lib64/libswscale.so.8.1.100
/V4/usr/lib64/libavcodec.so.61.3.100
/V4/usr/lib64/libavdevice.so.61.1.100
/V4/usr/lib64/libavfilter.so.10.1.100
/V4/usr/lib64/libavformat.so.61.1.100
/V4/usr/lib64/libavutil.so.59.8.100
/V4/usr/lib64/libpostproc.so.58.1.100
/V4/usr/lib64/libswresample.so.5.1.100
/V4/usr/lib64/libswscale.so.8.1.100
/usr/lib64/libavcodec.so.61
/usr/lib64/libavcodec.so.61.3.100
/usr/lib64/libavdevice.so.61
/usr/lib64/libavdevice.so.61.1.100
/usr/lib64/libavfilter.so.10
/usr/lib64/libavfilter.so.10.1.100
/usr/lib64/libavformat.so.61
/usr/lib64/libavformat.so.61.1.100
/usr/lib64/libavutil.so.59
/usr/lib64/libavutil.so.59.8.100
/usr/lib64/libpostproc.so.58
/usr/lib64/libpostproc.so.58.1.100
/usr/lib64/libswresample.so.5
/usr/lib64/libswresample.so.5.1.100
/usr/lib64/libswscale.so.8
/usr/lib64/libswscale.so.8.1.100
